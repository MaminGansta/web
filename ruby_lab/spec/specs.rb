...
RSpec.describe 'Application', type: :feature do
  ...
  it 'Check /options' do
    ...
    fill_in('city', with:'Ярославль')
    fill_in('date', with:'19.6')
    click_on('Показать')
  ...
  it 'Ckeck add/del trains' do
    ...
    click_on('Поезда')
    click_on('Добавить')
    fill_in('number', with: '107')
    fill_in('from', with: 'Воронеж')
    fill_in('to', with: 'Москва')
    fill_in('d_date', with: '20.6')
    fill_in('a_date', with: '22.6')
    fill_in('d_time', with: '12:43')
    fill_in('a_time', with: '16:15')
